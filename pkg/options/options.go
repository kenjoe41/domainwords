...
func ScanFlags() Options {
	...
	iterationsPtr := flag.UintP("iterations", "i", 10, "Number of Iterations of shuffling, chunking, and permutation [For BIG wordlists].") //TODO: Remmebr to bring this down when you confirm the program can already handle all these iterations.
